...
proc create_root_design { parentCell } {
  ...
  set clk104_out [ create_bd_port -dir O -type clk clk104_out ]
  set clk125_out [ create_bd_port -dir O -type clk clk125_out ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {rst_125_out} \
 ] $clk125_out
  set clk208_out [ create_bd_port -dir O -type clk clk208_out ]
  ...
  connect_bd_net -net pcs_pma_clk104_out [get_bd_ports clk104_out] [get_bd_pins pcs_pma/clk104_out]
  ...
  connect_bd_net -net pcs_pma_clk208_out [get_bd_ports clk208_out] [get_bd_pins pcs_pma/clk208_out]
